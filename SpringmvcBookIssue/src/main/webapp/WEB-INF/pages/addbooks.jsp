...
<nav class="navbar navbar-expand-lg fixed-top" >
 ...
 <div class="container mt-5 pt-5">
  ...
  <form:form action="savebook" method="post" modelAttribute="book" class="needs-validation">
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-md-4">
        ...
        <div class="form-group">
          ...
          <form:input type="text" id="authorName" path="authorName"   class="form-control" required="required" />
        </div>
        <div class="form-group">
          <label for="category">Category</label>
          
          <form:input type="text" id="category" path="category"   class="form-control"  required="required"/>
        </div>
        <div class="form-group">
          <label for="publisher">Publisher</label>
          <form:input type="text" id="publisher" path="publisher"   class="form-control"  required="required"/>
        </div>
        <div class="form-group">
          <label for="price">Price</label>
          <form:input type="text" id="price" path="price"  class="form-control" required="required"/>
        </div>
        <div class="form-group">
          <label for="noofCopies">NoofCopies</label>
          <form:input type="text" id="noofCopies" path="noofCopies"  class="form-control" required="required" />
        </div>
